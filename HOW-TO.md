...
## INDEX, README, HOW-TO what?
By default jekyll uses index.md/index.html as landing page. To maintain consistent view of our repository and webpage, we use a permalink in `README.md` for our readme to display as landing page.
In other words, any update to our landing page should be done in `README.md`, `index.md` should NEVER exist.
README/documentation is put in the file `HOW-TO.md`.

## Lecture, why are they in a prefixed folder??
Jekyll regards folders with a `_`-prefix as dynamic and all configurations by default expect folders for collections/scss/layouts etc. to be prefixed with a `_`.

This means that you must upload your lectures to the `_lectures/` folder and not `lectures` in order for the deployment of our page to work as intended.
